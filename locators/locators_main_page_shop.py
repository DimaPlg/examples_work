...
class MainPageShop(WebPage):

    def __init__(self, web_driver, url=''):
        if not url:
            url = os.getenv("MAIN_URL") or 'https://www.hellomerch.com/collections/weekly-world-news'

        super().__init__(web_driver, url)

    wwn_shop_page_header_search = WebElement(xpath=' //*[@role="search"]')
    wwn_shop_page_header_logo = WebElement(xpath='(//*[@class="header__logo-image"])')
    wwn_shop_page_email_subscription = WebElement(xpath='//*[@aria-controls="newsletter-popup"]')
    wwn_shop_page_header_login_page_link = WebElement(xpath='//*[@aria-label="Login"]')
    wwn_shop_page_mini_cart = WebElement(xpath='//*[@aria-controls="mini-cart"]')
